    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="flex flex-col justify-center items-center space-y-2">
                <img class="w-28 h-28 rounded-full border-2 border-gray-300" src="{{ asset('author.jpg') }}" alt="Mazhar Tuhin">
                <h1 class="font-bold text-2xl">Mazhar Tuhin</h1>
        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="flex flex-col justify-center items-center space-y-2">
                ...
                <ul class="flex items-center flex-wrap space-x-3 justify-center">
                    ...
                    <li><a class="hover:text-blue-500 transition-colors duration-100" href="{{ route('tags.show', 'php') }}">PHP</a></li>
                    <li><a class="hover:text-blue-500 transition-colors duration-100" href="{{ route('tags.show', 'plugin') }}">Plugin</a></li>
                </ul>
            </div>
        </div>
    </div>
